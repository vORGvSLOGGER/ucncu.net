      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <Link href="/profile" className="flex items-center gap-2.5">
          <div className="relative">
            <Avatar name={game.player.name} avatarId={game.player.avatarId} size={44} ring />
        ...
        <div className="ms-auto flex items-center gap-2 overflow-x-auto">
          <div className="chip">
            ...
            <span>النقدية</span>
            <b className="text-ink">{fmtInt(game.balances.UCN)}</b>
          ...
          <div className="chip border-gold/40">
            <span className="text-gold">◆</span>
            <span>الثروة</span>
